...
.sidebar-bar{   }
.sidebar-container{padding:0.01em 16px}
.sidebar-tab{   box-shadow: 0px 1px 1px 0px #7b7b7b52;}
.sidebar-button{     transition: 0.5s;
    ...
    cursor: pointer;
    white-space: nowrap;}
 .sidebar-button:hover{    background: linear-gradient(to right, #292E49, #005282, #292E49);}
  .sidebar-button:active{    background: linear-gradient(to right, #292E49, #007bc3, #292E49);}
.sidebar-toolbar-btn-gray{    color: #c5c5c5!important;
    background: #1e2328;
...
<input type="text"  placeholder=" " name="keywordsidebar" id="keywordsidebar" style="display:none">
      ...
      <div  id="view_sidebar_tab"> <?php include"anime/sidebar_fetch.php"; ?></div>
      </div>
...
function search_sidebar(page_number, search){
  ...
  type: 'POST', // Tentukan type nya POST atau GET
  data: {keywordsidebar: $("#keywordsidebar").val(), page: page_number, search: search}, // Set data yang akan dikirim
  dataType: "json",
 beforeSend: function(e) {
      $("#loader2").show();
...
{  -webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.3);  background-color: #272727;}
...
#in_view_judul{color: #fff;    width: 86%;
    font-size: larger;font-style: italic;}


/* CSS IFRAME Multiple Stream Video
   ================================  */
#--title-anime{display: block;    color: #fff;
    text-align: center;
    padding: 5px;
    font-size: 14px;
    font-weight: 800;
    box-shadow: 0px 0px 1px 0px;}
#--iframe-video{display:block;overflow:hidden;clear:both;text-align:center;    box-shadow: 0px 0px 1px 0px;
   
    margin-top: -6px;}
#--iframe-video a{display: inline-block;float:left;
...
#--iframe-video.--tab-eps:before{    content: 'Pilih server :';
    display: block;
...
, #464646, #383838);
    ...
    color: white;}
.btn_serv:hover{background: #194067;}

.loaddaftareps{ width: 100%;
    height: auto;
    margin-top: 10px;
    overflow: auto;
...
.selectedbtniframe{  background:dodgerblue!important;}
.btn_eps{ border: 2px solid #00adff;
    ...
    transition: all .2s;}
.btn_eps:hover{background: #5d5d5d;}


.download_temp{height:auto;     max-height: 350px;overflow:auto; box-shadow: 0px 0px 1px 0px;}
.download_temp h2{font-style: italic;text-align:center;color: white; margin-top: 4%;}
.loaddaftardownload{}
.culdownload{  display: flex;
    background: #333333;
    padding: 0.7%;
    color: wheat;
    list-style: none;
...
.culdownload span{  
    ...
    width: 88px;
    font-size: 12px;}
.culdownload li {     padding: 1px 3px 2px 2px;
    margin: 1px 2px 0px 0px;
    background-image: linear-gradient( 45deg , #464646, #383838);
}
.culdownload li:hover{background: #194067;}
.culdownload li .btn-download{     margin: 0px 4px 0px 4px;
    color: #ddd;
    font-size: 11px; }


.batch_temp{height:auto;     max-height: 350px;overflow:auto; box-shadow: 0px 0px 1px 0px;}
.batch_temp h2{font-style: italic;text-align:center;color: white; margin-top: 4%;}
.loaddaftarbatch{ display: flex;background: #333333;}
.btn-batch{ margin: 0px 0px 0px 2px;
    color: #ddd;
    font-size: 12px;
    background-image: linear-gradient( 45deg , #464646, #383838);
    padding: 6px 7px 6px 7px; }
.btn-batch:hover{background: #194067;color: white;}

.inview-bar{   box-shadow: 0px 1px 1px 0px #7b7b7b52;}
.inview-red,.inview-hover-red:hover{color:#fff!important;background-color:#f44336!important}
.inview-container{padding:0.01em 16px}
.inview-button{border:none;display:inline-block;padding:8px 16px;vertical-align:middle;overflow:hidden;text-decoration:none;color:inherit;background-color:inherit;text-align:center;cursor:pointer;white-space:nowrap}

.inview-ul-info{list-style: none;    padding: 1%;}
.inview-ul-info li{    padding: 2px;    margin: 0.5%;    box-shadow: rgb(125 125 125 / 55%) 0px 1px 1px;    text-transform: capitalize;width: 100%;}
.inview-ul-info span{    width: 20%;}
.inview-ul-info span:nth-child(2){font-weight: 600;    width: 80%;}
.inview-info-tab-status{color: dodgerblue;cursor: pointer;}
.inview-info-tab-status:hover{color: #7cbeff;}
.inview-info-tab-status:active{color: #f44336;}
.inview-info-tab-tipe{color: dodgerblue;cursor: pointer;}
.inview-info-tab-tipe:hover{color: #7cbeff;}
.inview-info-tab-tipe:active{color: #f44336;}
.inview-info-tab-studio{color: dodgerblue;cursor: pointer;}
.inview-info-tab-studio:hover{color: #7cbeff;}
.inview-info-tab-studio:active{color: #f44336;}
.inview-info-tab-tahun{color: dodgerblue;cursor: pointer;}
.inview-info-tab-tahun:hover{color: #7cbeff;}
.inview-info-tab-tahun:active{color: #f44336;}
.inview-info-tab-musim{color: dodgerblue;cursor: pointer;}
.inview-info-tab-musim:hover{color: #7cbeff;}
.inview-info-tab-musim:active{color: #f44336;}
.inview-info-tab-tagar a{color: dodgerblue;cursor: pointer;}
.inview-info-tab-tagar a:hover{color: #7cbeff;}
.inview-info-tab-tagar a:active{color: #f44336;}
.inview-info-tab-tipe{text-transform: uppercase;}
.inview-info-tab-ket{text-align: justify;padding: 2%;}

.inview-ul-info-genre{    list-style: none;
    display: flex;
    width: 100%;
    flex-wrap: wrap;}
.inview-ul-info-genre li{    padding: 4px 5px 4px 5px;
    margin: 3px 3px 1px 1px;
    background: transparent;
    cursor: pointer;
    border: 2px solid #337ab7;
    color: #30bbff;}
.inview-ul-info-genre li:hover{background: dodgerblue;color: white;}
.inview-ul-info-genre li:active{background: #f44336;}
</style>
<div  id="loader3"><div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div> 
<div id="in_view_form"  title="Detail">
      ...
      <!-- iframe -->
      <span id="--title-anime">Episode 12</span><div class="--show-video">   
      <iframe allowfullscreen="true" id="iframeid" frameborder="0" height="360" marginheight="0" marginwidth="0" scrolling="no" src="" width="100%">   </iframe></div><div class="tabs --tab-eps" id="--iframe-video">  <!--tombol akan muncul disini--></div>
...
var g=anime.length;
var e=$(".--tab-eps");
for(var h=0;h<g;h++){e.append("<a class='ganti-eps' data-id='"+h+"' data-eps='Episode "+(h+1)+"'>"+(h+1)+"</a>")}
  var f=$(".--show-video");
$(".ganti-eps").click(function(){f.html('<div class="--responsive"><iframe onload="hideLoadingiframe()" id="iframeid" src="'+anime[parseInt($(this).data("id"))]+'" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="360"  ></iframe></div>');});

// btn klik ganti eps 
$("body").on("click", ".ganti-eps", function(){
var f2=$(".--show-video"); f2.html('<div  id="loader4"><div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div> <div class="--responsive"><iframe onload="hideLoadingiframe()" id="iframeid"  src="'+$(this).data("id")+'" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="360"></iframe></div>');
if ($(this).hasClass("selectedbtniframe")) {}else { $(".ganti-eps").removeClass('selectedbtniframe'); $(this).addClass('selectedbtniframe'); }
...
var f2=$(".--show-video"); f2.html('<div  id="loader4"><div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div> <div class="--responsive"><iframe onload="hideLoadingiframe()" id="iframeid"   src="'+$(this).data("id")+'" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="360"></iframe></div>');
if ($(this).hasClass("selectedbtniframe")) {}else { $(".ganti-serv").removeClass('selectedbtniframe'); $(this).addClass('selectedbtniframe'); }
$("#--title-anime").text($(this).data("eps"))
});
  ...
  var id = $(this).attr('id');  
    ...
    $.ajax({
      ...
      { 
        ...
        $( ".inview-info-tab-studio" ).html(data.vstudio);$('.inview-info-tab-studio').attr('id', data.vstudio);
        $( ".inview-info-tab-tanggalrilis" ).html(data.vtanggalrilis);
        $( ".inview-info-tab-tahun" ).html(data.vtahun);$('.inview-info-tab-tahun').attr('id', data.vtahun);
        $( ".inview-info-tab-musim" ).html(data.vmusim);$('.inview-info-tab-musim').attr('id', data.vmusim);
        $( ".inview-info-tab-durasi" ).html(data.vdurasi);
        $( ".inview-info-tab-status" ).html(data.vstatus);$('.inview-info-tab-status').attr('id', data.vstatus);
        $( ".inview-info-tab-tipe" ).html(data.vtipe);$('.inview-info-tab-tipe').attr('id', data.vtipe);
        ...
        var iii = 0;for (var ii =0;ii< data.vepisode.length; ii++) {iii = ii;}
       ...
       //load btn server download v2 
        try { var myHtml3 = ""; var ceklop = 1;var ceklopkoma = 0.5;
         try {var cekgetardownload =  String(data.vgetarrdownload.length);}catch(err) {cekgetardownload=""}
        if(cekgetardownload == ""){ $(".download_temp").css("display","none") }else{$(".download_temp").css("display","block")
        for (var i = 0;i< data.vgetarrdownload.length;i++) {
          var cek1 = parseFloat(data.vgetarrdownload[i][0]) ;  
          if(cek1 == ceklopkoma){ myHtml3 += "</ul><ul class='culdownload'> <span>Episode "+data.vgetarrdownload[i][0]+' </span>';   ceklopkoma++;}else{} 
          if(cek1 == ceklop){ myHtml3 += "</ul><ul class='culdownload'> <span>Episode "+data.vgetarrdownload[i][0]+' </span>';  ceklop++; ceklopkoma = cek1 + 0.5;
          }else{
            var vceklopkoma =ceklopkoma-1;
            var vceklop =ceklop-1;
                if(cek1 != vceklopkoma  && cek1 != vceklop ){
                   myHtml3 += "</ul><ul class='culdownload'> <span>Episode "+data.vgetarrdownload[i][0]+' </span>'; ceklop =cek1+1;ceklopkoma = cek1 + 0.5;   }  } 
        myHtml3 += "<li><a class='btn-download' target='_blank' href='"+data.vgetarrdownload[i][1]+"'>"+data.vgetarrdownload[i][3]+'('+data.vgetarrdownload[i][2]+")</a></li>";  } myHtml3 += "</ul>";$( ".loaddaftardownload" ).html( myHtml3 );  
         }} catch(err) {}


        //load btn batch download
       try{  try {var cekbatchdownload =  String(data.vbatchdownload.length);}catch(err) {cekbatchdownload=""} 
        if(cekbatchdownload == ""){ $(".batch_temp").css("display","none") }else{$(".batch_temp").css("display","block")
            myHtml4 ="";
          ...
          }$( ".loaddaftarbatch" ).html( myHtml4 );  }} catch(err) {}
          $("#loader3").hide();
  ...
  var episode = $(this).first().text();
   console.log(episode);
    ...
    $.ajax({
      url:"anime/action.php",
      method:"POST",
      data:{id_judul:id_judul, episode:episode, action:action},
      dataType:"json",
      success:function(data)
      { 
         //load btn server
...
.card {    flex: 0 47%;    margin: 10px 4px 5px 5px; }

.header1{    text-align: center;    float: none;    padding: 0;}

.topnav a:not(:first-child) {display: none;}
.topnav a.icon {    float: right;    display: block;  }

.logo1 {     padding: 15px 0px 0px 0px;}
.logo1 img{    width: 29%;    text-align: center;    float: none;    margin: 0;}

#navibaru {       white-space: nowrap;    overflow: auto;    width: 108%;    position: relative;    left: -35px;}
#navibaru a {    float: none;     display: inline-block;}

.topnav.responsive {position: relative;}
.topnav.responsive .icon {    position: absolute;    right: 0;    top: 0;  }
.topnav.responsive a {    float: none;    display: block;    text-align: left;  }

#myTopnav{position: fixed;z-index: 5}

#in_view_form{  margin: 0%;top: 0%;
...
#loader3{    margin: 0%;
    ...
    text-align: center;
    padding: 15% 0% 0% 0%;}
#loader4{height: 160px;}
iframe{height: 220px;}
}

/* Small devices (portrait tablets and large phones, 600px and up) */
@media only screen and (min-width: 600px) {
.card {    flex: 0 31%;    margin: 10px 4px 5px 5px; }
#in_view_form{  margin: 0%;top: 0%;
    left: 0%; width: 100%;height: 100%;}
#loader3{    margin: 0%;
    top: 0%;
...
.card {     flex: 0 23%;    margin: 10px 9px 5px 5px;}
} 

/* Large devices (laptops/desktops, 992px and up) */
@media only screen and (min-width: 992px) {
.card {      flex: 0 24%;    margin: 10px 2px 5px 5px;}
} 

/* Extra large devices (large laptops and desktops, 1200px and up) */
@media only screen and (min-width: 1200px) {
.card {      flex: 0 19%;    margin: 10px 4px 5px 5px; }
}
</style>