...
<style type="text/css">
  ...
  .pagination_utama>li>a,
  .pagination_utama>li>span {
    position: relative;
    float: left;
    padding: 3px 6px;
  ...
  .pagination_utama>li:first-child>a,
  .pagination_utama>li:first-child>span {
    margin-left: 0;
    border-bottom-left-radius: 4px;
    border-top-left-radius: 4px
  }

  .pagination_utama>li:last-child>a,
  .pagination_utama>li:last-child>span {
    border-bottom-right-radius: 4px;
    border-top-right-radius: 4px
  }

  .pagination_utama>li>a:hover,
  .pagination_utama>li>span:hover,
  .pagination_utama>li>a:focus,
  .pagination_utama>li>span:focus {
    color: #2a6496;
    background-color: #eee;
    border-color: #ddd
  }

  .pagination_utama>.active>a,
  .pagination_utama>.active>span,
  .pagination_utama>.active>a:hover,
  .pagination_utama>.active>span:hover,
  .pagination_utama>.active>a:focus,
  .pagination_utama>.active>span:focus {
    z-index: 2;
    color: #fff;
  ...
  .pagination_utama>.disabled>span,
  .pagination_utama>.disabled>span:hover,
  .pagination_utama>.disabled>span:focus,
  .pagination_utama>.disabled>a,
  .pagination_utama>.disabled>a:hover,
  .pagination_utama>.disabled>a:focus {
    color: #999;
    background-color: #fff;
    border-color: #ddd;
    cursor: not-allowed
  ...
  .pagination_utama-lg>li>a,
  .pagination_utama-lg>li>span {
    padding: 10px 16px;
    font-size: 18px
  }

  .pagination_utama-lg>li:first-child>a,
  .pagination_utama-lg>li:first-child>span {
    border-bottom-left-radius: 6px;
    border-top-left-radius: 6px
  }

  .pagination_utama-lg>li:last-child>a,
  .pagination_utama-lg>li:last-child>span {
    border-bottom-right-radius: 6px;
    border-top-right-radius: 6px
  }

  .pagination_utama-sm>li>a,
  .pagination_utama-sm>li>span {
    padding: 5px 5px;
    font-size: 10px
  }

  .pagination_utama-sm>li:first-child>a,
  .pagination_utama-sm>li:first-child>span {
    border-bottom-left-radius: 3px;
    border-top-left-radius: 3px
  }

  .pagination_utama-sm>li:last-child>a,
  .pagination_utama-sm>li:last-child>span {
